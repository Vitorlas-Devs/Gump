    ...
    <custom-scrollbar :auto-expand="false" h="screen" w="full" pb="40">
      <div flex="~ col" justify="between" gap="6">
        ...
        <div>
          ...
          Include these strings in your translations the same way that they are in the English text.
          <ol class="cool-ol">
            <li>
          ...
          <ol class="cool-ol">
            <li>
              ...
              <a href="https://translate.google.com/" target="_blank" class="link-orange"
                >Google Translate</a
              >,
              <a href="https://chat.openai.com/chat" target="_blank" class="link-orange">ChatGPT</a
              >,
        ...
        <div>
          ...
          <ol class="cool-ol">
            ...
            <li>
              ...
              less often, but often enough that you don't accidentally lose your work, as refreshing
              the page will do just that.
            </li>
            <li>
